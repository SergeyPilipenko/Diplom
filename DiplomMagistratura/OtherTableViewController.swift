...
class OtherTableViewController: UITableViewController {
    ...
    let titleSectionsArray = ["Геолокация", "Избранное"]
    let titlesArray = [["Автоматически", "Выберите город"], ["Избранные кинотеатры", "Избранные фильмы"]]
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        ...
        return titleSectionsArray.count
    }
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return titleSectionsArray[section]
    }
